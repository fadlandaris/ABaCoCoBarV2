...
export default function PdfCard() {
  return (
    <div className='h-[220px] w-[300px] sm:h-[300px] flex flex-col justify-between p-1 rounded-2xl bg-[#e6e2d9] shadow-[0px_0px_8px_0px_#fcf8ef]'>
      <div className='rounded-2xl w-full h-full flex flex-col justify-between gap-y-1 sm:gap-y-3'>
        <div className='w-full h-[85%] rounded-2xl bg-[#fcf8ef] p-1 grid grid-cols-1 gap-y-1'>
          <div className='bg-[#f0ece3] rounded-2xl font-secondary text-foreground tracking-tighter font-normal flex items-center overflow-hidden'>
            <div className='w-full'>
              <p className='pl-3 sm:mb-1 font-medium'>ABaCoCoBar</p>
